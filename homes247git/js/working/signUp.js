...
app.factory ('signupFactory',function(networking){
 ...
 app.directive('googlePlusSignin', function ($window, $rootScope,signupFactory,$state,loginFactory) {
  ...
  app.config(function(socialProvider){
	...
	socialProvider.setGoogleKey("608917643346-cet34nn56ool3bcnnu0k8ohndc3sjvnk.apps.googleusercontent.com");

//  socialProvider.setFbKey({appId: "2135655260052112", apiVersion: "v2.11"});
  socialProvider.setFbKey({appId: "288942455189000", apiVersion: "v3.1"});
});
...
//$rootScope.$on('event:google-sign-in-success',function(event, obj){
//    console.log(event);
